...
output "regions" {
  value = "${list(
    "${module.aws_roachprod-ap-northeast-1.roachprod_region_info}",
    "${module.aws_roachprod-ap-northeast-2.roachprod_region_info}",
    "${module.aws_roachprod-ap-south-1.roachprod_region_info}",
    "${module.aws_roachprod-ap-southeast-1.roachprod_region_info}",
    "${module.aws_roachprod-ap-southeast-2.roachprod_region_info}",
    "${module.aws_roachprod-ca-central-1.roachprod_region_info}",
    "${module.aws_roachprod-eu-central-1.roachprod_region_info}",
    "${module.aws_roachprod-eu-west-1.roachprod_region_info}",
    "${module.aws_roachprod-eu-west-2.roachprod_region_info}",
    "${module.aws_roachprod-eu-west-3.roachprod_region_info}",
    "${module.aws_roachprod-sa-east-1.roachprod_region_info}",
    "${module.aws_roachprod-us-east-1.roachprod_region_info}",
    "${module.aws_roachprod-us-east-2.roachprod_region_info}",
    "${module.aws_roachprod-us-west-1.roachprod_region_info}",
    "${module.aws_roachprod-us-west-2.roachprod_region_info}"
  )}"
}
