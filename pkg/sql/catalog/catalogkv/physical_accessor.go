...
func (a UncachedPhysicalAccessor) GetDatabaseDesc(
	...
	// NB: Take care to actually return nil here rather than a
...
func (a UncachedPhysicalAccessor) GetObjectDesc(
	...
	if tableDesc := rawDesc.Table(hlc.Timestamp{}); tableDesc != nil {
		...
		if flags.RequireMutable {
			return sqlbase.NewMutableExistingTypeDescriptor(rawDesc), nil
		}
		return sqlbase.NewImmutableTypeDescriptor(rawDesc), nil
	}
	return nil, nil
