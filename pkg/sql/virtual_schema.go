...
func initVirtualDatabaseDesc(id sqlbase.ID, name string) *sqlbase.ImmutableDatabaseDescriptor {
	return sqlbase.NewImmutableDatabaseDescriptor(&sqlbase.Descriptor{
		DescriptorMeta: sqlbase.MakeInitialDescriptorMeta(id, name),
		Union: &sqlbase.Descriptor_Database{Database: &sqlbase.DatabaseDescriptor{
