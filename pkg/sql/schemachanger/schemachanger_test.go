...
func TestRollback(t *testing.T) {
	...
	ctx := context.Background()
	setup := func(t *testing.T, i int64) (db *gosql.DB, injectedFailure func() bool, restart, cleanup func()) {
		var seen int64
				...
				Knobs: base.TestingKnobs{
					SQLDeclarativeSchemaChanger: &scrun.TestingKnobs{
						BeforeStage: func(p scplan.Plan, stageIdx int) error {
							...
							if !injectedFailure() && atomic.LoadInt64(&seen) == i {
...
ORDER BY create_statement;`)
	...
	runSubtest := func(t *testing.T, testCase test, i int64) (done bool) {
