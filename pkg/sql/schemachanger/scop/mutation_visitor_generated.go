...
type MutationVisitor interface {
	...
	MakeBackfilledIndexDeleteOnly(context.Context, MakeBackfilledIndexDeleteOnly) error
...
// Visit is part of the MutationOp interface.
func (op MakeBackfilledIndexDeleteOnly) Visit(ctx context.Context, v MutationVisitor) error {
	return v.MakeBackfilledIndexDeleteOnly(ctx, op)
}
